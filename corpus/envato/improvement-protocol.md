...
| Q-09  | `ParagraphShading` / `RuleAbove` / `RuleBelow` / `ParagraphBorder` (P-10 redux)    | Text      | Major    |  5+/61   | L      | ParagraphShading + RuleAbove + RuleBelow end-to-end landed; ParagraphBorder deferred |
