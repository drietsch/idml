...
- **Total: 310 across the workspace** (CPU default features). `text_glyph_level` (the new file landed for Tier-1 #6) contributes 8 to that total (+1 for Tier-2 #9 bullet character style).
