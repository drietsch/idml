...
| Overprint simulation | ✅ parser + display list + Stage 3 CPU darken + Stage 4A per-channel CMYK composite when source paint is CMYK; Stage 4B (full CMYK pipeline) + Stage 4C (spot ink planes) deferred — see Tier 3 #14 |
