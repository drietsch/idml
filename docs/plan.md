...
14. **Fidelity harness expansion** — pair seed IDMLs with InDesign reference PDFs, run `idml-fidelity` ΔE2000+SSIM in CI, gate merges on regression. Cascade + tabs + Vello + real metrics + bullets + numbering all make this newly meaningful.
